# Opex: Autonomous Agentic Development System
...
| 12 | [12-repo-connection.md](docs/specs/12-repo-connection.md) | GitHub App + PAT auth, cloning, webhooks, `.opex.yaml` full spec |
